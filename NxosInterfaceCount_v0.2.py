...
class NexusInterfaceCount:
    ...
    def collect_info(self):
        ...
        command = "show int e3/2 | in 'Ethernet|port-channel|%s' | exclude Hardware | exclude fifo"%self.new_word  #for e3/2 only
        show = cli(command)
...
if __name__ == "__main__":
    ...
    if args.action == 'execute_command':
        cli_cmd = input('Type show command, when there are space enclose it with <">:')
